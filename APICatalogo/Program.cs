...
builder.Services.AddAuthorization(options =>
{
    ...
    options.AddPolicy("SuperAdminOnly", policy =>
                       policy.RequireRole("Admin").RequireClaim("id", "gustavo"));
    ...
    options.AddPolicy("ExclusiveOnly", policy =>
                      ...
                      context.User.HasClaim(claim =>
                                           claim.Type == "id" && claim.Value == "gustavo")
...
{
    // app.MapOpenApi();//nativo

    app.UseSwagger();
    app.UseSwaggerUI(c =>
      {
          c.SwaggerEndpoint("/swagger/v1/swagger.json", "apicatalogo v1");
          c.RoutePrefix = string.Empty; // opcional: Swagger na raiz
      });
